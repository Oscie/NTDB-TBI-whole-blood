# Read 2021 datasets output from SAS
# added collapsed DC

# Input:    trauma2021v4.csv  
#           transfusion_codes_2021.csv
# Output:   df = compute dataset used in analyses, now set to df_select
...
saveRDS(df, "df2021.rds")

transfusion_codes <- 
  read.csv("transfusion_codes_2021.csv") %>% 
  clean_names()
