...
proc sort data=lib2020.puf_ICDprocedure_lookup out=icd_lookup;
	by icdprocedurecode;
run;
...
* procedure codes for transfusions;
...
proc export data=transfusions
	outfile="\transfusion_codes_2020.csv"
	dbms = dlm
	replace;
	delimiter=',';
run;
...
data lib04.transfused_patients_2020;
