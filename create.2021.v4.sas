/*******************************************************************
2021 dataset, B0749 whole blood analysis TBI polytrauma

output:	trauma2021v4.csv
********************************************************************/
...
data puf_trauma;
	set lib2021.puf_trauma /*(obs=40000)*/ ;
	keep inc_key 
...
proc sort data=lib04.transfused_patients_2021 out=transfused_patients;
	by inc_key;
run;
...
proc sort 	data=lib2021.tqp_inclusion
			out=tqp_inclusion;
	by inc_key;
run;
...
data lookup1998;
	set lib2021.puf_aisdiagnosis_lookup;
	where AISversion = "AIS 1998";
...
data puf_HospitalEvents;
	set lib2021.puf_HospitalEvents ;
...
data puf_PreExistingConditions;
	set lib2021.puf_PreExistingConditions ;
